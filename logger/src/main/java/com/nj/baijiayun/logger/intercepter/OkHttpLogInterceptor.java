...
import com.nj.baijiayun.logger.formater.FormatException;
import com.nj.baijiayun.logger.formater.JsonFormatter;
import com.nj.baijiayun.logger.formater.XmlFormatter;
...
public class OkHttpLogInterceptor implements Interceptor {
    ...
    public OkHttpLogInterceptor(IPrinter logger) {
        this.logger = logger;
    }
